...
#R codes for Lasso regression-adjusted ABC for resulting posterior correction
Post_Lasso_reg_adj<- function(post_distn,summary_obs,copula_type=copula_type,N) {
